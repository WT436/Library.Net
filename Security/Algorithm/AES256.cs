...
{
    //source : https://docs.microsoft.com/en-us/dotnet/api/system.security.cryptography.aes?view=net-5.0
    public class AES256
    {
        public byte[] EncryptAES256StringToBytes_Aes(string plainText, byte[] Key, byte[] IV)
        {
            // Check arguments.
